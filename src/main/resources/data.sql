...
insert into T_TICKET (TITLE,DESCRIPTION,SEVERITY,STATUS,ASSIGNED_USER_ID,CREATED_USER_ID,PROJECT_ID) values ('ticket 4','description 1','0','0','2','3','PJ101');
insert into T_TICKET (TITLE,DESCRIPTION,SEVERITY,STATUS,ASSIGNED_USER_ID,CREATED_USER_ID,PROJECT_ID) values ('ticket 4','description 1','0','0','2','3','PJ103');
insert into T_TICKET (TITLE,DESCRIPTION,SEVERITY,STATUS,ASSIGNED_USER_ID,CREATED_USER_ID,PROJECT_ID) values ('ticket 4','description 1','0','0','3','2','PJ104');
